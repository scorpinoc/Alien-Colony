...
namespace Data.Data.JobActions
{
    ...
    public class MoveAction : JobAction
    {
        ...
        public MoveAction(PositionAction nextAction, uint ticks, DataContainer ownerContainer) : base(ownerContainer, nextAction)
        {
            if (nextAction == null)
        ...
        private void NewDirection(Position current)
        {
            _direction = current.X == _targetPosition.X
                ? Direction.Stop
                : (current.X > _targetPosition.X ? Direction.South : Direction.North);
